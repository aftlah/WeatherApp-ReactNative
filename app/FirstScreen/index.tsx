   ...
   return (
      ...
      <ThemedView style={{ flex: 1, position: 'relative' }}>
         ...
         <SafeAreaView style={{ display: 'flex', flex: 1, alignItems: 'center', marginTop: 40 }}>
                           ...
                           locations.map((loc, i) => {
                              ...
                              return (
                                 <TouchableOpacity
                                    ...
                                    key={i}
                                    style={{ flexDirection: 'row', alignItems: 'center', borderWidth: 0, padding: 12, paddingHorizontal: 16, borderBottomWidth: 2, borderColor: '#9CA3AF' }}
                                 >
            ...
            <View style={{ marginBottom: 4, marginTop: 12, width: '100%' }}>
               <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start', marginHorizontal: 20, marginLeft: 8 }}>
               ...
               >
                  <View style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: 96, borderRadius: 24, marginLeft: 4, marginRight: 16, backgroundColor: 'rgba(255,255,255, 0.15)' }}>
                     <Image
